...
const WebDevelopment = () => {
  ...
  const technologies = [
    ...
    { name: "Next.js", category: "Framework", logo: nextjsLogo },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="bg-blue-50 rounded-xl p-6">
                <div className="text-2xl font-bold text-blue-600 mb-2">Starting at $2,999</div>
                <p className="text-gray-600">Complete web development package with modern technologies</p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {technologies.map((tech, index) => (
              <div key={index} className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 text-center flex flex-col items-center">
                <img src={tech.logo} alt={tech.name + ' logo'} className="w-12 h-12 mb-3" />
